...
extern void
BX_my_encrypt(char *str, int len, char *key)
{
...
extern void
BX_my_decrypt(char *str, int len, char *key)
{
	int key_len, key_pos, i;
	char mix, tmp;
...
static char *
do_crypt(char *str, char *key, int flag)
{
	int c;
	char *ptr = NULL;
