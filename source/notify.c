...
void
rebuild_notify_ison(int server)
{
	int i;
...
void
ison_notify(char *AskedFor, char *AreOn)
{
	char *NextAsked;
	char *NextGot;
...
void
add_to_notify_queue(char *buffer)
{
...
void
notify_count(int server, int *on, int *off)
{
	NotifyItem *tmp;
	int i;
...
void
check_auto_invite(char *nick, char *userhost)
{
#ifdef WANT_USERLIST
...
void
batch_notify_userhost(char *nick)
{
...
void
dispatch_notify_userhosts(void)
{
...
void
notify_userhost_dispatch(UserhostItem * stuff, char *nick, char *text)
{
...
void
notify_userhost_reply(char *nick, char *userhost)
{
	NotifyItem *tmp;
 ...
 */
void
notify_mark(char *nick, char *userhost, int flag, int doit)
{
	NotifyItem *tmp;
	int count = 0;
	int loc = 0;
...
char   *
get_notify_nicks(int showserver, int showon, char *nick, int extra)
{
	char *list = NULL;
	int i = 0;
...
char   *
get_watch_nicks(int showserver, int showon, char *nick, int extra)
{
	char *list = NULL;
	int i = 0;
...
int
iswatch(int serv, char *list, int all)
{
	if (all) {
		int servnum;
...
void
show_watch_notify(char *from, int online, char **args)
{
	NotifyItem *new_n;
