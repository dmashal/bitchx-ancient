...
/*
 * Version 1.0 released with BitchX 75 $Id: scr-bx.c 119 2011-04-08
 * 12:29:55Z keaston $
 */
...
void
display_socket_list(char *path, int unl, char *arg)
{
	DIR *dptr;
	struct dirent *dir;
	struct stat st;
...
char   *
find_detach_socket(char *path, char *name)
{
	char *new_path;
	DIR *dptr;
	struct dirent *dir;
