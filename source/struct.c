...
int
setup_structure(char *name, char *which, Window ** win, DCC_int ** dcc, ChannelList ** chan, NickList ** nick, int *server)
{
	int i;
	int serv = -1;
...
static inline int
get_offset_int(void *tmp, int offset)
{
...
static inline char *
get_offset_str(void *tmp, int offset)
{
...
static inline char *
get_offset_char(void *tmp, int offset)
{
	char *s = (char *)((char *)tmp + offset);
...
static inline void
set_offset_int(void *tmp, int offset, int val)
{
...
static inline void
set_offset_str(void *tmp, int offset, const char *val)
{
...
static inline void
set_offset_char(void *tmp, int offset, const char *val)
{
	char *ptr = (char *)((char *)tmp + offset);
...
int
lookup_code(LookupStruct * t, char *name)
{
	int i;
...
char   *
return_structure(LookupStruct * name, void *user)
{
	int j;
	char *ret = NULL;
	char *s;
...
char   *
lookup_structure_item(int idx, LookupStruct * name, void *user, char *arg)
{
	if (!user || (idx == -1))
		return NULL;
...
char   *
lookup_structure_member(int type, char *name, char *rest, NickList * n, ChannelList * ch, Window * w, DCC_int * dcc, int serv)
{
...
char   *
call_structure_internal(char *name, char *args, char *rest, char *rest1)
{
	Window *win = NULL;
