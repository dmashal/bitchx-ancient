...
#if 0
[Sheik(~sheik @ spartan.pei.edu)]
notice in struct.h that the cset struct *does *
...
#include "irc.h"
static char cvsrevision[]
        = "$Id: cset.c 108 2011-02-02 12:13:54Z keaston $";
 ...
 */
static void
*get_cset_var_address(CSetList * tmp, int var)
{
 ...
 */
int
BX_get_cset_int_var(CSetList * tmp, int var)
{
...
char   *
BX_get_cset_str_var(CSetList * tmp, int var)
{
 ...
 */
void
BX_set_cset_int_var(CSetList * tmp, int var, int value)
{
	int *ptr = get_cset_var_address(tmp, var);
...
void
BX_set_cset_str_var(CSetList * tmp, int var, const char *value)
{
	char **ptr = get_cset_var_address(tmp, var);
 ...
 */
static int
find_cset_variable(CSetArray * array, char *org_name, int *cnt)
{
	CSetArray *v, *first;
	int var_index;
	char *name = NULL;
...
static void
set_cset_var_value(CSetList * tmp, int var_index, char *value)
{
	char *rest;
	CSetArray *var;
...
CSetList *
check_cset_queue(char *channel, int add)
{
	CSetList *c = NULL;
	int found = 0;
...
static inline void
cset_variable_case1(char *channel, int var_index, char *args)
{
	...
	/*
	 * implement a queue for channels that don't exist... later... go
	 * home if user doesn't have any channels.
	 */
...
static inline void
cset_variable_casedef(char *channel, int cnt, int var_index, char *args)
{
	ChannelList *chan = NULL;
	int tmp, tmp2;
	int count = 0;
...
static inline void
cset_variable_noargs(char *channel)
{
	int var_index = 0;
	ChannelList *chan = NULL;
	int count = 0;
...
char   *
set_cset(char *var, ChannelList * chan, char *value)
{
	int var_index, cnt = 0;
...
char   *
get_cset(char *var, ChannelList * chan, char *value)
{
	int var_index, cnt = 0;
...
CSetList *
create_csets_for_channel(char *channel)
{
	CSetList *tmp;
...
void
remove_csets_for_channel(CSetList * tmp)
{
...
static int
find_wset_variable(WSetArray * array, char *org_name, int *cnt)
{
	WSetArray *v, *first;
	int var_index;
	char *name = NULL;
 ...
 */
char   *
BX_get_wset_string_var(WSet * tmp, int var)
{
 ...
 */
static char **
get_wset_str_var_address(WSet * tmp, int var)
{
	char **ptr = (char **)((unsigned long)tmp + wset_array[var].offset);
 ...
 */
char  **
get_wset_format_var_address(WSet * tmp, int var)
{
	char **ptr = NULL;
...
void
BX_set_wset_string_var(WSet * tmp, int var, char *value)
{
	char **ptr = (char **)((unsigned long)tmp + wset_array[var].offset);
...
static void
set_wset_var_value(Window * win, int var_index, char *value)
{
	WSetArray *var;
...
static inline void
wset_variable_case1(Window * win, char *name, int var_index, char *args)
{
	Window *tmp = NULL;
	int count = 0;
	int i;
...
static inline void
wset_variable_casedef(Window * win, char *name, int cnt, int var_index, char *args)
{
	Window *tmp = NULL;
	int count = 0;
	int c, i;
...
static inline void
wset_variable_noargs(Window * win, char *name)
{
	Window *tmp = NULL;
	int var_index = 0;
...
WSet   *
create_wsets_for_window(Window * win)
{
	WSet *tmp;
...
void
remove_wsets_for_window(Window * tmp)
{
...
void
log_channel(CSetArray * var, CSetList * cs)
{
	ChannelList *chan;
...
void
set_msglog_channel_level(CSetArray * var, CSetList * cs)
{
	ChannelList *chan;
...
void
do_logchannel(unsigned long level, ChannelList * chan, char *format,...)
{
...
void
set_channel_limit(ChannelList * channel, int currentlimit, int add, int numusers)
{
...
void
check_channel_limit(ChannelList * chan)
{
...
void
limit_channel(CSetArray * var, CSetList * cs)
{
	ChannelList *chan;
...
#ifdef GUI
CSetArray *
return_cset_var(int nummer)
{
	return &cset_array[nummer];
}

WSetArray *
return_wset_var(int nummer)
{
