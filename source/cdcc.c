		...
		*buffer = 0;
		...
		for (i = 0; *local[i].name; i++) {
			if (my_stricmp(local[i].name, cmd))
				continue;
			snprintf(buffer, sizeof buffer, "CDCC %s", cmd);
...
char   *
msgcdcc(char *from, char *to, char *args)
{
	int i;
	char *secure = NULL;
...
static int
do_local_send(char *command, char *args, char *rest)
{
	pack *ptr = NULL;
...
static int
do_dcc_sends(char *command, char *from, char *args)
{
	pack *ptr;
	char *temp = NULL, *file = NULL, *dccinfo = NULL, *q = NULL, *p;
	char *password = NULL;
...
int
BX_add_to_queue(char *nick, char *command, pack * sendpack)
{
...
static void
get_minspeed(char *args, char *rest)
{
	char *last = NULL;
...
static int
l_minspeed(char *args, char *rest)
{
	char *temp = NULL;
...
static void
get_ptimer(char *args, char *rest)
{
	if (rest && *rest)
...
static void
get_pchannel(char *args, char *rest)
{
...
static void
add_note1(unsigned long pnum, char *note)
{
	pack *this_pack = NULL;
	unsigned long i;
...
static void
add_describe(unsigned long pnum, char *describe)
{
	pack *this_pack = NULL;
	unsigned long i;
...
static void
get_pnote1(char *args, char *rest)
{
	if (got_pnum && rest)
...
static void
get_describe(char *args, char *rest)
{
	unsigned long pnum = 0;
	char *temp = NULL;
	char *p;
...
static int
l_describe(char *args, char *rest)
{
	char *temp = NULL;
...
static void
add_password(unsigned long pnum, char *password)
{
	pack *this_pack = NULL;
	unsigned long i;
...
static void
get_passwd(char *args, char *rest)
{
	if (got_dnum && rest)
...
static void
get_password(char *args, char *rest)
{
	unsigned long pnum = 0;
	char *temp = NULL;
	char *p;
