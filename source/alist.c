 ...
 */
Array_item *
BX_remove_from_array(Array * array, char *name)
{
...
Array_item *
BX_array_pop(Array * array, int which)
{
	Array_item *ret = NULL;
 ...
 */
Array_item *
BX_remove_all_from_array(Array * array, char *name)
{
	int count, location = 0;
	Array_item *ret = NULL;
...
Array_item *
BX_array_lookup(Array * array, char *name, int wild, int delete)
{
	int count, location;
 ...
 */
Array_item *
BX_find_array_item(Array * set, char *name, int *cnt, int *loc)
{
 ...
 */
void   *
BX_find_fixed_array_item(void *list, size_t size, int howmany, char *name, int *cnt, int *loc)
{
	size_t len = strlen(name);
	int min = 0, max = howmany, old_pos = -1, pos,
	    c;
