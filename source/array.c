 ...
 */
extern void
insert_index(long **index, long *size, long newIndex)
{
	long cnt;
 ...
 */
extern void
move_index(an_array * array, long oldindex, long newindex)
{
	long temp;
 ...
 */
extern long
find_index(an_array * array, long item)
{
	long i = 0;
