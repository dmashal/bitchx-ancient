 ...
 */
void
BX_add_to_list_ext(List ** list, List * add, int (*cmp_func)(List *, List *))
{
	List *tmp;
	List *last;
...
void
BX_add_to_list(List ** list, List * add)
{
 ...
 */
List   *
BX_find_in_list_ext(List ** list, char *name, int wild, int (*cmp_func)(List *, char *))
{
	List *tmp;
...
List   *
BX_find_in_list(List ** list, char *name, int wild)
{
 ...
 */
List   *
BX_remove_from_list_ext(List ** list, char *name, int (*cmp_func)(List *, char *))
{
	List *tmp;
	List *last;
...
List   *
BX_remove_from_list(List ** list, char *name)
{
	return remove_from_list_ext(list, name, NULL);
}

List   *
BX_removewild_from_list(List ** list, char *name)
{
 ...
 */
List   *
BX_list_lookup_ext(List ** list, char *name, int wild, int delete, int (*cmp_func)(List *, char *))
{
	List *tmp;
...
List   *
BX_list_lookup(List ** list, char *name, int wild, int delete)
{
