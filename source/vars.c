 ...
 */
int
BX_get_int_var(enum VAR_TYPES var)
{
 ...
 */
void
BX_set_string_var(enum VAR_TYPES var, char *string)
{
	if (string)
 ...
 */
void
BX_set_int_var(enum VAR_TYPES var, unsigned int value)
{
...
void
set_var_value(int var_index, char *value, IrcVariableDll * dll)
{
	char *rest;
	IrcVariable *var;
	int old;
...
char   *
make_string_var(const char *var_name)
{
	int cnt, msv_index;
	char *ret = NULL;
	char *copy;
...
void
reinit_autoresponse(Window * win, char *value, int unused)
{
...
#ifdef WANT_OPERVIEW
static void
set_ov_mode(Window * win, char *value, int unused)
{
...
static void
set_away_time(Window * win, char *unused, int value)
{
	if (value == 0)
...
void
toggle_reverse_status(Window * win, char *unused, int value)
{
	if (!value)
...
#ifdef WANT_TCL
char   *
ircii_rem_str(ClientData * cd, Tcl_Interp * intp, char *name1, char *name2, int flags)
{
	char *s;
	IrcVariable *n;
...
static void
set_clock_format(Window * win, char *value, int unused)
{
...
static void
set_dcc_timeout(Window * win, char *unused, int value)
{
...
static void
set_use_socks(Window * win, char *value, int unused)
{
...
int
parse_mangle(char *value, int nvalue, char **rv)
{
	char *str1, *str2;
	char *copy;
	char *nv = NULL;
...
static void
set_mangle_inbound(Window * w, char *value, int unused)
{
	char *nv = NULL;
...
static void
set_mangle_outbound(Window * w, char *value, int unused)
{
	char *nv = NULL;
...
static void
set_mangle_logfiles(Window * w, char *value, int unused)
{
	char *nv = NULL;
...
static void
set_mangle_operlog(Window * w, char *value, int unused)
{
	char *nv = NULL;
...
static void
set_nat_address(Window * w, char *value, int unused)
{
	char *nv = NULL, *h;
