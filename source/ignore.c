 ...
 */
char   *
get_ignores_by_pattern(char *patterns, int covered)
{
	Ignore *tmp;
	char *pattern;
	char *retval = NULL;
...
int
get_type_by_desc(char *type, int *do_mask, int *dont_mask)
{
	char *l1, *l2;
	int len;
	int *mask = NULL;
 ...
 */
char   *
get_ignore_types_by_pattern(char *pattern)
{
	Ignore *tmp;
...
char   *
get_ignore_patterns_by_type(char *ctype)
{
	Ignore *tmp;
