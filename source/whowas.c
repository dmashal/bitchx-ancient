...
void
sync_whowas_adduser(UserList * added)
{
	WhowasList *tmp;
...
void
sync_whowas_unuser(UserList * entry)
{
	WhowasList *tmp;
...
void
sync_whowas_addshit(ShitList * added)
{
	WhowasList *tmp;
...
void
sync_whowas_unshit(ShitList * entry)
{
	WhowasList *tmp;
...
check_whowas_chan_buffer(char *channel, int refnum, int unlink)
{
