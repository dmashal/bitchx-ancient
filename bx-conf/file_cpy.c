...
char	main_foreground = COLOR_WHITE, main_background = COLOR_BLUE, dialog_foreground,
        dialog_background;
char	status_foreground, status_background, help_foreground, help_background;
char	directory_foreground, directory_background, onvol_foreground, onvol_background;
char	selected_foreground = COLOR_BLUE, selected_background = COLOR_WHITE, bottom_foreground,
        bottom_background;
 ...
 */
int
insert_fdlist(CELL * c, struct _config_type *current)
{
    dlistptr ptr = NULL;
