/*
 * irc_std.h: header to define things used in all the programs ircii comes
 * with
 *
 * hacked together from various other files by matthew green copyright(c) 1993
 *
...
/*
 * Figure out how to make alloca work I took this from the autoconf
 * documentation
 */
...
/*
 * DCC specification requires exactly a 32 bit checksum. Kind of lame,
 * actually.
 */
