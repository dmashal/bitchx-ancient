 ...
 *
 * Written By Michael Sandrof Copyright(c) 1990
 *
...
#ifndef __irc_h
#define __irc_h
#define IRCII_COMMENT   "\002 Sky's the limit!\002"
...
/*
 * This section is for keeping track internally the CVS revision info of the
 * running client. Since so many people are using CVS versions for debugging
 * purposes it's good to know what file revisions they are running.
 */
#define CVS_REVISION(id) \
        void id (char *buf)                 \
	{                       \
		strlcpy(buf, cvsrevision, sizeof buf);       \
	}
