/*
 * IRC-II (C) 1990, 1995 Michael Sandroff, Matthew Green This file (C) 1993,
 * 1995 Aaron Gifford and Jeremy Nelson
 *
 * array.h -- header file for array.c See the COPYRIGHT file for copyright
 * information
 *
 */
