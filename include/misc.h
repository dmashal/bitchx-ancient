/*
 * Copyright Colten Edwards 1997. various miscellaneous routines needed for
 * irc functions
 */
...
BanList        *ban_is_on_channel(char *, ChannelList *);
BanList        *eban_is_on_channel(char *, ChannelList *);
...
#define getrandom(min, max) ((bsd_arc4random() % (int)(((max)+1) - (min))) + (min))
