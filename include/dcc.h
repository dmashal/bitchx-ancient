...
/*
 * these are all used in the bot_link layer. the dcc_printf is used in a few
 * other places as well. ie dcc.c
 */
...
/*
 * these definitions are mostly used by ircII as well I expanded the flags to
 * a full 32 bits to allow for future expansion.
 */
#define DCC_PACKETID  0xfeab    /* used to figure out endianess as well as
				 * identify the resend packet */
#define MAX_DCC_BLOCK_SIZE 16384 /* this is really arbritrary value. we can
				 * actually make this a lot larger and things
				 * will still work as expected. The network
				 * layer places a limit however. */
